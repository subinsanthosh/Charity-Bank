...
if(isset($_POST['type'])){
    ...
    $sql = "INSERT INTO `charity`.`utensils` (`type`, `quantity`, `username`, `dt`) VALUES ('$type', '$quantity', '$user', current_timestamp());";
    // echo $sql;
...
window.onunload = function () { null };
	...
	<link rel="stylesheet" type="text/css" href="utensils.css">
...
<div class="dn">
<p>Donate Utensils Here</p>
</div>

<div class="main">

<form action="utensils.php" method="post">
  <div class="con">
  </div> 
      <div class="in">
       <div class="subm">
